...
def train_advanced_model():
    ...
    X_train, X_val, y_train_no2, y_val_no2 = train_test_split(X_scaled, y_no2, test_size=0.2, random_state=42)
    ...
    print('Advanced models saved as Source/models/advanced_model.pkl')

    # For report: Print best model details
    print("\nBest Model Details for Report:")
    print(f"OZONE - Best Model: {best_o3_model.__class__.__name__}, MAE: {best_o3_score}, Params: {best_o3_params}")
    print(f"NO2 - Best Model: {best_no2_model.__class__.__name__}, MAE: {best_no2_score}, Params: {best_no2_params}")